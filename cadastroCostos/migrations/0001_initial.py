# Generated by Django 2.1.1 on 2018-12-22 21:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_mes', models.CharField(choices=[('A', 'Abierto'), ('C', 'Cerrado')], max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Cad_ing_ret',
            fields=[
                ...
                ('slug', models.SlugField(unique=True)),
                ('fecha_trabajo', models.DateField(default=datetime.datetime.now)),
                ('ind_ing_egr', models.CharField(choices=[('I', 'Ingreso'), ('E', 'Egreso')], default='I', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ind_C_V_A', models.CharField(choices=[('C', 'Consumo'), ('V', 'Venta'), ('A', 'Ambos')], default='C', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imp_venta', models.DecimalField(decimal_places=2, max_digits=5)),
                ('imp_restaurante', models.DecimalField(decimal_places=2, max_digits=5)),
                ('imp_renta', models.DecimalField(decimal_places=2, max_digits=5)),
                ('mesas', models.SmallIntegerField()),
                ('billetes', models.CharField(blank=True, max_length=100, null=True)),
                ('accesorapido', models.CharField(blank=True, max_length=200, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Cad_stock',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('O', 'Orden'), ('P', 'Pagado'), ('C', 'Comanda')], max_length=1)),
                ('modo_pago', models.CharField(choices=[('E', 'Efectivo'), ('T', 'Tarjeta')], default='E', max_length=1)),
                ('notas', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad_venta', models.DecimalField(decimal_places=2, max_digits=8)),
