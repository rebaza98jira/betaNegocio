...
urlpatterns = [
    ...
    url('nuevoMesaOrdenIngreso/(?P<slug>[\w-]+)/$', Cad_mesas_orden_Create.as_view(), name='cad_mesa_crear_orden_ingreso'),
    url('nuevoMesaIngreso/(?P<mesa>\d+)/$', Cad_mesas_Create.as_view(), name='cad_mesa_crear_ingreso'),
    url('mesaOrdenPagar/(?P<slug>[\w-]+)/$', Cad_mesas_Pagar.as_view(), name='cad_mesa_pagar_orden'),
    # url('mesaOrdenPagar/$', Cad_mesas_Pagar.as_view(), name='cad_mesa_crear_orden_ingreso'),
    ...
    url(r'ajax/retornaJsonInsumos/$', retornaJsonInsumos, name='retornaJsonInsumos'),
    url(r'ajax/estado_mesas/$', estado_mesas, name='estado_mesas'),
    url('listarCajaIngresos', Cad_ing_ret_List_I.as_view(), name='cad_ing_ret_listar_i'),
    url('listarCajaEgresos', Cad_ing_ret_List_E.as_view(), name='cad_ing_ret_listar_e'),
    url('listarCaja', Cad_ing_ret_List.as_view(), name='cad_ing_ret_listar'),

    url('nuevoCajaIngreso', Cad_ing_ret_Create_I.as_view(), name='cad_ing_ret_crear_i'),
    url('nuevoCajaEgreso', Cad_ing_ret_Create_E.as_view(), name='cad_ing_ret_crear_e'),
    url('editarCajaIngreso/(?P<pk>\d+)/$', Cad_ing_ret_Update_I.as_view(), name='cad_ing_ret_editar_i'),
    url('editarCajaEgreso/(?P<pk>\d+)/$', Cad_ing_ret_Update_E.as_view(), name='cad_ing_ret_editar_e'),
